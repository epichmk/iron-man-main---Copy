        ...
        <div className="flex flex-col items-center text-center z-30">
          <div className="flex flex-col items-center gap-3 mb-6">
            ...
            <motion.div 
              ...
              className="flex items-center gap-4 bg-black/60 rounded-full px-5 py-2 border border-white/10 backdrop-blur-md"
            >
            ...
            >
              <span 
                className="text-[10px] font-bold tracking-widest text-zinc-300 bg-black/40 px-4 py-1.5 rounded-full border border-white/10 backdrop-blur-sm"
                style={{ boxShadow: "0 5px 15px rgba(0,0,0,0.8)" }}
              >
