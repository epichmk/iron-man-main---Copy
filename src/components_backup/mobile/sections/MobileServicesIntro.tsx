...
export function MobileServicesIntro() {
  return (
    <section className="relative w-full h-screen snap-start overflow-hidden bg-[#000814] flex flex-col items-center justify-center" dir="rtl">
      {/* Background Video */}
      <LazyVideo
      ...
      <div className="relative w-full flex flex-col items-center justify-center px-6 z-20">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          {/* Top minimal badge */}
          <div className="mb-6 inline-flex items-center gap-3 px-5 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
            <div className="w-2 h-2 rounded-full bg-accent animate-pulse shadow-[0_0_10px_#d4e616]" />
            <span className="font-sans text-xs font-bold tracking-widest text-zinc-300 uppercase pt-1">
          ...
          <p className="font-sans text-lg text-zinc-400 font-light leading-relaxed max-w-[300px]">
