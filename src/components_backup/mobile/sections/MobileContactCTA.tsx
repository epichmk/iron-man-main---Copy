  ...
  return (
    <section className="relative w-full h-screen snap-start overflow-hidden bg-[#000814]" dir="rtl">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#000814] via-[#000814]/80 to-[#000814]/40" />
      </div>

      <div className="relative z-10 w-full h-full flex flex-col justify-end px-6 pb-12">
        {/* Header Block */}
        <div className="flex flex-col mb-8">
          <div className="h-0.5 w-10 bg-[#d4e616] mb-4 rounded-full opacity-80 shadow-[0_0_10px_#d4e616]" />
          <h2 className="text-4xl font-bold text-white leading-tight mb-3 tracking-tight dark:drop-shadow-md">
            ابدأ رحلتك
          </h2>
        ...
        {/* Contact Links Stack */}
        <div className="flex flex-col gap-4 w-full bg-black/40 backdrop-blur-xl p-6 rounded-3xl border border-white/10 shadow-2xl overflow-y-auto max-h-[60vh] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb]:rounded-full">
          ...
          <a href={getWhatsAppLink("مرحباً، أود حجز موعد.")} target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-5 group">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white/50 text-[10px] font-medium mb-0.5">واتساب (للحجز)</span>
                <span className="text-white font-sans text-sm tracking-wide" dir="ltr">+967 781 878 443</span>
             </div>
          </a>
          ...
          <a href="tel:+9671513729" className="flex items-center justify-start gap-5 group">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white/50 text-[10px] font-medium mb-0.5">الاستقبال</span>
                <span className="text-white font-sans text-sm tracking-wide" dir="ltr">+967 1 513 729</span>
             </div>
          </a>
          ...
          <a href="tel:+967775950500" className="flex items-center justify-start gap-5 group">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white/50 text-[10px] font-medium mb-0.5">الاستشارات الطبية</span>
                <span className="text-white font-sans text-sm tracking-wide" dir="ltr">+967 775 950 500</span>
             </div>
          </a>
          ...
          <a href="mailto:ivfnmc@gmail.com" className="flex items-center justify-start gap-5 group">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white/50 text-[10px] font-medium mb-0.5">البريد الإلكتروني</span>
                <span className="text-white font-sans text-sm tracking-wide" dir="ltr">ivfnmc@gmail.com</span>
             </div>
          </a>
          ...
          <a href="https://maps.app.goo.gl/n8KvHLgkjQbbiBpz8" target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-5 group">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white font-medium text-sm">صنعاء، جولة فلسطين</span>
             </div>
          </a>
          ...
          <div className="flex items-center justify-start gap-5 group cursor-default">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white font-medium text-[11px] mb-0.5">ساعات العمل</span>
                <span className="text-[#d4e616] text-[10px] font-medium">السبت - الخميس | 9:00 ص - 3:00 م</span>
             </div>
          </div>
          ...
          <div className="flex items-center justify-start gap-5 group cursor-default">
             ...
             <div className="flex flex-col text-right">
                <span className="text-white font-medium text-[11px] mb-0.5">أوقات الاتصال</span>
                <span className="text-[#d4e616] text-[10px] font-medium">السبت - الخميس | 9:00 ص - 9:00 م</span>
             </div>
          </div>

          {/* Cohesive Elegant Socials */}
          <div className="flex flex-col gap-3 pt-4 mt-1 border-t border-white/10 w-full">
             <a href="https://www.instagram.com/dr.najat_almalass_center" target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-5 group">
                ...
                <div className="flex flex-col items-start text-right">
                   <span className="text-white font-medium text-[11px] mb-0.5">انستجرام</span>
                   <span className="text-white/50 text-[10px] font-medium" dir="ltr">@dr.najat_almalass_center</span>
                </div>
             </a>
             ...
             <a href="https://www.facebook.com/najatalmalascenter" target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-5 group">
                ...
                <div className="flex flex-col items-start text-right">
                   <span className="text-white font-medium text-[11px] mb-0.5">فيسبوك</span>
                   <span className="text-white/50 text-[10px] font-medium" dir="ltr">/najatalmalascenter</span>
                </div>
             </a>
             ...
             <a href={getWhatsAppLink("مرحباً، أود التواصل معكم.")} target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-5 group">
                ...
                <div className="flex flex-col items-start text-right">
                   <span className="text-white font-medium text-[11px] mb-0.5">واتساب</span>
                   <span className="text-white/50 text-[10px] font-medium" dir="ltr">+967 781 878 443</span>
                </div>
             </a>
          </div>
        </div>
