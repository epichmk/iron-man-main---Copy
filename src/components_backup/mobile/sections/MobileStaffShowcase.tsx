    ...
    <section className="relative w-full h-screen snap-start overflow-hidden bg-[#000814]" dir="rtl">
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-end pt-24">
        ...
        <div className="absolute top-16 inset-x-0 z-30 flex flex-col items-center text-center px-6 pointer-events-none">
          ...
          <p className="font-sans text-[11px] text-[#d4e616] tracking-wide uppercase mb-2">
            عقولٌ رائدة
          </p>
          <p className="font-sans text-[11px] text-zinc-300 font-medium max-w-[280px] dark:drop-shadow-md leading-relaxed">
        ...
        <AnimatePresence mode="popLayout" initial={false} custom={direction}>
          ...
          >
            ...
            <div className="absolute inset-x-0 top-48 z-30 flex flex-col items-center text-center px-6">
              <p className="text-white font-light leading-[1.5] text-[15px] mb-4 dark:drop-shadow-[0_4px_10px_rgba(0,0,0,1)]">
              ...
              <div className="mt-6 flex flex-col items-center">
                <span className="font-mono tracking-[0.2em] uppercase px-5 py-2 rounded-full text-[12px] text-[#d4e616] bg-black/60 border border-[#d4e616]/30 backdrop-blur-md mb-3 shadow-[0_0_15px_rgba(212,230,22,0.2)]">
                  {activeStaff.title}
                </span>
                <h3 className="font-heading font-black text-4xl text-white mb-3 dark:drop-shadow-[0_4px_10px_rgba(0,0,0,1)]">
                  {activeStaff.name}
                </h3>
      ...
      <div className="absolute bottom-8 inset-x-0 flex flex-col justify-center items-center gap-4 z-40 pointer-events-none" dir="rtl">
        ...
        <div className="flex items-center gap-3 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
          <span className="font-sans text-[10px] text-zinc-300 tracking-[0.1em] uppercase font-bold">
