...
export function Baby3DSection() {
  ...
  return (
    <section
      ...
      style={{ height: "300vh", marginBottom: "-100vh" }}
    >
      <div
      ...
      >
        ...
        <div className="pointer-events-none absolute right-6 top-28 z-10 flex max-w-[46ch] flex-col items-end gap-5 text-right md:right-12 md:top-32">
          ...
          <p className="max-w-[42ch] font-sans text-sm leading-relaxed text-zinc-400 md:text-base bg-background/50 p-2 rounded backdrop-blur-sm">
