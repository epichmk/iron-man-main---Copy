...
export function FeaturedServicesGrid() {
  return (
    <section id="services" className="relative w-full py-32 bg-[#000814] overflow-hidden" dir="rtl">
      {/* Background Glow */}
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        <div className="mb-20 flex flex-col items-center text-center">
          ...
          <h2 className="text-5xl md:text-7xl font-bold text-white tracking-tight font-elite mb-6">
        ...
        <div className="mt-20 flex justify-center">
          <Link href="/services" className="group relative overflow-hidden bg-white/5  px-10 py-4 rounded-full flex items-center gap-3 hover:bg-white/10  transition-all duration-300">
            <span className="text-white font-bold tracking-wider text-sm">استكشف جميع الخدمات</span>
            <ArrowUpRight size={16} className="text-[#d4e616] group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
          </Link>
        </div>
      </div>
    </section>
