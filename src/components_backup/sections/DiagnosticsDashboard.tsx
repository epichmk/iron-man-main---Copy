    ...
    >
      ...
      <div className="relative w-36 h-36 sm:w-44 sm:h-44 lg:w-48 lg:h-48 flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          <span className="font-heading text-[clamp(2rem,4vw,3.5rem)] font-black text-white dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] tabular-nums">
      ...
      <div className="relative z-20 container mx-auto px-4 md:px-8 lg:px-12 w-full flex flex-col justify-center h-full">
        <div className="flex flex-col items-center mb-6 md:mb-10 lg:mb-12">
          <motion.h2 
            ...
            className="font-heading text-[clamp(2.5rem,6vw,5rem)] font-black text-white text-center tracking-tighter"
            dir="rtl"
          >
          ...
          <motion.p
            ...
            className="mt-4 md:mt-6 font-sans text-zinc-400 text-[clamp(1rem,2vw,1.25rem)] max-w-2xl text-center leading-[1.6] md:leading-[1.8] font-light"
            dir="rtl"
          >
