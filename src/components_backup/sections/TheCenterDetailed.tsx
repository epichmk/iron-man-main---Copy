      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {FACILITY_AREAS.map((a, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ backgroundColor: i === activeArea ? a.accent : "rgba(255,255,255,0.1)" }}
              />
              <div className="flex flex-col items-start relative z-10">
                <span className={`text-sm font-bold transition-colors duration-300 ${i === activeArea ? "text-white" : "text-zinc-500"}`}>
                  {a.title}
                </span>
        ...
        <div className="lg:col-span-9">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Description Bar */}
              <div className="flex items-center justify-between mb-5 p-4 bg-white/[0.02]  rounded-2xl">
                <p className="text-sm text-zinc-400 font-light leading-relaxed flex-1 text-balance">{area.description}</p>
                <div className="flex-shrink-0 mr-4 flex items-center gap-2 px-4 py-2 rounded-xl" style={{ background: `${area.accent}10`, border: `1px solid ${area.accent}20` }}>
                  ...
                  <span className="text-[10px] text-zinc-500 font-mono">{area.statLabel}</span>
                </div>
              </div>
                ...
                {area.images.map((img, i) => (
                  <motion.div
                    ...
                    className={`relative rounded-2xl overflow-hidden  cursor-pointer group ${
                      i === 0 && area.images.length > 2 ? "col-span-2 row-span-2 h-[260px] md:h-[360px]" : "h-[130px] md:h-[175px]"
                    }`}
                  >
                    <Image
                      src={img}
                    ...
                    {/* Expand icon */}
                    <div className="absolute bottom-3 right-3 w-8 h-8 rounded-full bg-black/60 backdrop-blur-md  flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 z-30 scale-75 group-hover:scale-100">
        ...
        {lightboxImg && (
          ...
          >
            <button
              ...
              className="absolute top-6 left-6 z-50 w-12 h-12 rounded-full bg-white/10  flex items-center justify-center text-white hover:bg-white/20 transition-colors"
            >
...
export function TheCenterDetailed() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full bg-transparent overflow-clip selection:bg-[#d4e616]/30 selection:text-white"
      dir="rtl"
    >
      {/* ──────── AMBIENT BACKGROUND ──────── */}
      <div className="fixed top-0 right-0 w-[70vw] h-[70vh] bg-[radial-gradient(ellipse_at_top_right,rgba(0,33,64,0.5)_0%,transparent_70%)] pointer-events-none z-0" />
      ...
      <section
        id="the-center-hero"
        ref={heroRef}
        className="relative z-10 w-full h-screen snap-start flex items-center justify-center overflow-hidden bg-transparent"
      >
        ...
        <motion.div style={{ scale: heroVideoScale, opacity: heroOpacity }} className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#000814]/50 via-[#000814]/20 to-[#000814]" />
        </motion.div>
        ...
        <motion.div style={{ y: heroBgY, opacity: heroOpacity }} className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-[1]">
          <h1 className="text-[10rem] md:text-[16rem] lg:text-[22rem] font-bold text-white whitespace-nowrap tracking-tighter opacity-[0.03]">
            NMC
          </h1>
        </motion.div>
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#d4e616]/5 blur-[120px] rounded-full pointer-events-none z-[1]" />
        ...
        <motion.div style={{ y: heroContentY, opacity: heroOpacity }} className="relative z-10 text-center px-6 max-w-[1000px]">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: "easeOut" }} className="flex flex-col items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} className="w-20 h-20 mb-8 relative">
              <Image src="/nmc-logo.png" alt="NMC Logo" fill className="object-contain drop-shadow-[0_0_30px_rgba(212,230,22,0.3)]" />
            </motion.div>

            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-[1px] bg-gradient-to-l from-[#d4e616] to-transparent" />
              <span className="text-[#d4e616] font-mono tracking-[0.3em] uppercase text-[10px] font-bold">Najat Medical Center — Est. 2018</span>
              <div className="w-16 h-[1px] bg-gradient-to-r from-[#d4e616] to-transparent" />
            </div>

            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 dark:drop-shadow-xl leading-tight text-balance">
              حيث يبدأ الحلم
            </h2>

            <p className="text-lg md:text-xl text-transparent bg-clip-text bg-gradient-to-l from-blue-400 to-white font-light mb-3">
              أول مركز متكامل للحقن المجهري وأطفال الأنابيب في اليمن
            </p>

            <p className="text-sm text-zinc-400/80 leading-relaxed font-light max-w-xl mb-10 text-balance">
            ...
            <div className="flex flex-wrap items-center justify-center gap-1">
              {[
                { value: "2018", label: "سنة التأسيس", color: "#d4e616" },
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 + i * 0.12, duration: 0.8 }} className="flex flex-col items-center gap-1 px-5 py-3 bg-white/[0.03]  rounded-2xl min-w-[100px]">
                  <span className="text-xl md:text-2xl font-bold text-white font-mono" dir="ltr">{stat.value}</span>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.8 }} className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-30">
          <span className="font-mono text-[9px] tracking-[0.2em] uppercase text-zinc-500">استكشف المركز</span>
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section id="the-center-story" className="relative z-10 w-full min-h-screen snap-start flex flex-col justify-center overflow-hidden py-20 md:py-28">
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, margin: "-100px" }} className="w-full max-w-[1300px] mx-auto px-6 md:px-12 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">

            {/* Right: Story */}
            <Parallax offset={-40} className="flex flex-col relative z-10 order-1">
              <motion.div variants={fadeUp}>
                <span className="text-[#d4e616] font-mono text-sm tracking-[0.3em] uppercase block mb-6">/ القصة</span>
                <span className="absolute -top-10 right-0 text-[8rem] text-white/[0.03] font-serif leading-none select-none pointer-events-none">&quot;</span>

                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-[1.4] mb-6 text-balance">
                  من حلم طبيبة إلى{" "}
                  <span className="text-transparent bg-clip-text bg-gradient-to-l from-blue-400 to-[#0066FF]">صرح طبي رائد</span>
                </h2>

                <p className="text-base md:text-lg text-zinc-300/80 leading-[1.8] font-light mb-5 text-balance">
                  في عام 2018، حين لم يكن في اليمن مركز متكامل واحد للحقن المجهري، قررت د. نجاة الملس — بعد سنوات من التدريب في بريطانيا ومصر — أن تنقل هذه التقنيات إلى أرض الوطن.
                </p>
                <p className="text-base text-zinc-400/70 leading-[1.8] font-light mb-8 text-balance">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-zinc-500 text-sm font-mono tracking-wider">— تأسس 2018، صنعاء</span>
                </div>
              </motion.div>
            </Parallax>
              ...
              <motion.div variants={fadeUp} className="relative w-full aspect-[3/4] max-h-[520px] rounded-3xl overflow-hidden  group shadow-2xl">
                ...
                <div className="absolute bottom-6 right-6 left-6 z-20">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-2 h-2 rounded-full bg-[#d4e616] animate-pulse" />
                    <span className="text-[#d4e616] font-mono text-[10px] tracking-[0.2em] uppercase">المؤسسة والمديرة الطبية</span>
                  </div>
                  <h3 className="text-xl font-bold text-white">د. نجاة الملس</h3>
                  <p className="text-xs text-zinc-400 font-light mt-1">البورد العربي في أمراض النساء والتوليد</p>
                </div>
              </motion.div>

              {/* Floating Badge */}
              <motion.div variants={fadeUp} className="absolute -bottom-4 -left-4 z-30 bg-[#000814]  rounded-2xl p-4 shadow-2xl backdrop-blur-xl border border-white/5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#d4e616]/10 flex items-center justify-center">
                    <span className="text-[#d4e616] font-mono text-sm font-bold">30+</span>
                  </div>
                  <div>
                    <p className="text-white text-sm font-bold">سنة خبرة</p>
                    <p className="text-zinc-500 text-[10px] font-mono">طب أسرة وإخصاب</p>
                  </div>
                </div>
              </motion.div>
            </Parallax>
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section id="the-center-mission" className="relative z-10 w-full min-h-screen snap-start flex flex-col justify-center overflow-hidden py-20 md:py-28">
        <div className="absolute top-0 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#d4e616]/5 blur-[100px] md:blur-[150px] rounded-full pointer-events-none" />
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, margin: "-100px" }} className="w-full max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          
          <Parallax offset={-30}>
            {/* The Golden Thread (Top Line) */}
            <div className="w-full h-px bg-gradient-to-l from-[#d4e616]/80 via-white/10 to-transparent mb-12 md:mb-20" />
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center w-full gap-16 lg:gap-20">
              ...
              <div className="flex flex-col items-center lg:items-end shrink-0">
                <motion.div variants={fadeUp} className="flex flex-col lg:flex-row items-center gap-4 lg:gap-6 mb-8 md:mb-12">
                  <div className="relative w-12 h-12 md:w-16 md:h-16 opacity-90 hover:scale-110 transition-transform duration-500">
                    <Image src="/nmc-logo.png" alt="NMC Logo" fill className="object-contain" />
                  </div>
                  <div className="flex items-center gap-4 lg:gap-6">
                    <span className="text-[#d4e616] font-mono tracking-[0.5em] uppercase text-xs md:text-sm">MISSION & VISION</span>
                    <div className="w-12 lg:w-24 h-px bg-gradient-to-r from-transparent via-[#d4e616]/60 to-[#d4e616]/60" />
                  </div>
                </motion.div>
                ...
                <motion.h2 variants={fadeUp} className="text-center lg:text-right text-[clamp(4.5rem,10vw,9rem)] font-black font-heading leading-[0.85] tracking-tight w-full flex flex-col items-center lg:items-end">
                  <span className="block text-white/90 hover:text-white transition-colors duration-500">رسالتنا</span>
              ...
              <div className="flex flex-col items-end gap-6 md:gap-8 mt-12 lg:mt-0 shrink-0">
                 <motion.div variants={fadeUp} className="border-r-4 border-[#d4e616] pr-6 md:pr-8 py-2 md:py-4 bg-gradient-to-l from-[#d4e616]/[0.02] to-transparent hover:from-[#d4e616]/[0.05] transition-colors duration-500">
                   <p className="text-zinc-300 text-lg md:text-xl lg:text-2xl leading-[1.8] md:leading-[2] font-light text-right max-w-[30ch]" dir="rtl">
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <section id="the-center-facility" className="relative z-10 w-full min-h-screen snap-start flex flex-col justify-center overflow-hidden py-20 md:py-28 bg-gradient-to-b from-transparent via-[#000a1a]/50 to-transparent">
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, margin: "-100px" }} className="w-full max-w-[1400px] mx-auto px-6 md:px-12">
          <Parallax offset={-25}>
            <motion.div variants={fadeUp} className="text-center mb-10 md:mb-14">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-[1.5] text-balance max-w-[800px] mx-auto">
                تجهيزات{" "}
      ...
      <section id="the-center-leadership" className="relative w-full py-32 md:py-48 bg-transparent overflow-hidden z-10">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-end justify-between mb-24 border-b border-white/5 pb-12">
            <ScrollReveal>
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-px bg-[#d4e616]" />
                <span className="text-[#d4e616] font-mono tracking-widest text-xs uppercase font-bold">Leadership</span>
              </div>
              <h2 className="text-5xl md:text-7xl font-black text-white font-heading leading-tight tracking-tight">
                قيادة برؤية<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-l from-zinc-500 to-zinc-300">استثنائية.</span>
              </h2>
            </ScrollReveal>
            <ScrollReveal className="max-w-md text-right mt-8 md:mt-0">
          ...
          <div className="relative flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-32">
            <Parallax offset={40} className="w-full lg:w-6/12 relative">
              <div className="relative aspect-square rounded-tr-[80px] rounded-bl-[80px] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] group">
                ...
                <div className="absolute bottom-8 right-8 z-20">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[#d4e616] font-mono text-[10px] tracking-[0.2em] uppercase">المديرة الطبية</span>
                  </div>
                  <h3 className="text-3xl font-bold text-white mb-1">د. نجاة الملس</h3>
                </div>
              </div>
              {/* Floating Stat */}
              <motion.div initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} className="absolute -left-12 top-1/4 bg-[#00050a]/80 backdrop-blur-xl border border-white/5 p-6 rounded-3xl hidden md:block">
                <p className="text-4xl font-black text-white font-mono mb-1">30<span className="text-[#d4e616]">+</span></p>
                <p className="text-xs text-zinc-500 font-mono tracking-widest uppercase">Years Experience</p>
              </motion.div>
            </Parallax>
            
            <ScrollReveal className="w-full lg:w-7/12 flex flex-col justify-center relative">
              <span className="text-[15rem] leading-none absolute -top-20 -right-10 text-white/[0.02] font-serif select-none pointer-events-none">1</span>
              <h4 className="text-3xl font-bold text-white mb-6 font-heading relative z-10">مؤسسة أول مركز للإخصاب المساعد في اليمن</h4>
              <p className="text-xl text-zinc-400 font-light leading-[2] mb-8 text-balance relative z-10">
              ...
              <ul className="flex flex-col gap-4 mb-10 relative z-10">
                {['تأسيس مركز NMC بمعايير عالمية', 'إدخال تقنيتي ICSI و IMSI لليمن', 'آلاف حالات النجاح الموثقة'].map((item, i) => (
                  <li key={i} className="flex items-center gap-4 text-zinc-300">
                    <div className="w-8 h-px bg-gradient-to-r from-transparent to-[#d4e616]" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              <div className="relative z-10">
                <Link href="/dr-najat" className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 rounded-full text-white font-medium transition-all duration-300 w-fit group">
                  <span>الملف الكامل</span>
                  <ArrowUpLeft className="w-4 h-4 text-[#d4e616] group-hover:-translate-x-1 group-hover:-translate-y-1 transition-transform" />
                </Link>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="relative flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
            <Parallax offset={-40} className="w-full lg:w-6/12 relative">
              <div className="relative aspect-square rounded-tl-[80px] rounded-br-[80px] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] group">
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent z-10" />
                <Image src="/staff/the center's director. dr. Khaled Ali Al-Gendari 3.png" alt="د. خالد الجنداري" fill className="object-cover transition-transform duration-[2s] group-hover:scale-105" />
                <div className="absolute bottom-8 right-8 z-20">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse" />
                    <span className="text-blue-400 font-mono text-[10px] tracking-[0.2em] uppercase">مدير المركز</span>
                  </div>
                  <h3 className="text-3xl font-bold text-white mb-1">د. خالد الجنداري</h3>
                </div>
              </div>
            </Parallax>
            
            <ScrollReveal className="w-full lg:w-7/12 flex flex-col justify-center relative">
              <span className="text-[15rem] leading-none absolute -top-20 -left-10 text-white/[0.02] font-serif select-none pointer-events-none">2</span>
              <h4 className="text-3xl font-bold text-white mb-6 font-heading relative z-10">القيادة الإدارية والتشغيلية</h4>
              <p className="text-xl text-zinc-400 font-light leading-[2] mb-8 text-balance relative z-10">
                يقود العمليات التنظيمية بكفاءة عالية، ضامناً سير العمل وفق أعلى معايير الجودة والخدمة المتميزة. تحت إدارته، يحافظ المركز على بيئة احترافية توفر أقصى درجات الراحة للمرضى.
              </p>
              <div className="grid grid-cols-2 gap-6 relative z-10">
                {[
                  { label: "الجودة", value: "معايير ISO" },
                  { label: "السرية", value: "تشفير كامل" },
                  { label: "العمليات", value: "كفاءة 100%" },
                  { label: "التطوير", value: "تحديث مستمر" },
                ].map((stat, i) => (
                  <div key={i} className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl">
                    <p className="text-sm text-zinc-500 mb-1 font-mono">{stat.label}</p>
      ...
      <section id="the-center-why" className="relative w-full py-32 md:py-48 bg-transparent overflow-hidden z-10">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          <ScrollReveal className="text-center mb-24">
            <h2 className="text-5xl md:text-7xl font-black text-white font-heading leading-tight tracking-tight mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            ...
            {/* Bento Box 1: Tech */}
            <ScrollReveal className="md:col-span-2 relative bg-[#000814] rounded-[2.5rem] p-10 md:p-14 overflow-hidden border border-white/5 group">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[8rem] font-black text-white/[0.02] absolute -top-10 -left-6 pointer-events-none select-none">TECH</span>
                </div>
                <div>
                  <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 font-heading">تقنيات الجيل المتقدم</h3>
                  <p className="text-lg text-zinc-400 font-light leading-relaxed max-w-lg text-balance">
            ...
            {/* Bento Box 2: Privacy */}
            <ScrollReveal className="relative bg-[#000814] rounded-[2.5rem] p-10 overflow-hidden border border-white/5 group">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.05)_0%,transparent_100%)] transition-transform duration-1000 group-hover:scale-150 pointer-events-none" />
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="w-14 h-14 rounded-full bg-white/5 flex items-center justify-center backdrop-blur-md border border-white/10">
                  <span className="text-xl font-bold text-white font-mono">02</span>
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3 font-heading">سرية وخصوصية مطلقة</h3>
            ...
            <ScrollReveal className="relative bg-[#000814] rounded-[2.5rem] p-10 overflow-hidden border border-white/5 group">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3 font-heading">معدلات نجاح تنافسية</h3>
            ...
            <ScrollReveal className="md:col-span-2 relative bg-[#000814] rounded-[2.5rem] p-10 md:p-14 overflow-hidden border border-white/5 group">
              <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[300px] h-[300px] bg-[#d4e616]/10 blur-[100px] group-hover:blur-[150px] transition-all duration-700 pointer-events-none" />
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="flex justify-end">
                  <div className="w-16 h-16 rounded-2xl bg-[#d4e616]/10 flex items-center justify-center backdrop-blur-md border border-[#d4e616]/30">
                    <span className="text-2xl font-black text-[#d4e616] font-mono">04</span>
                  </div>
                </div>
                <div className="text-right flex flex-col items-end">
                  <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 font-heading">رعاية إنسانية شاملة</h3>
                  <p className="text-lg text-zinc-400 font-light leading-relaxed max-w-lg text-balance">
      ...
      <section
        id="the-center-cta"
        className="relative z-10 w-full h-screen snap-start flex flex-col justify-center overflow-hidden border-t border-white/5"
      >
        {/* Ambient orbs */}
        <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-[#d4e616]/10 blur-[200px] rounded-full pointer-events-none" />
        ...
        <div className="w-full max-w-[900px] mx-auto px-6 md:px-12 text-center relative z-10">
          <ScrollReveal>
            {/* Eyebrow */}
            <div className="mb-8 inline-flex items-center gap-3 #d4e616]/30 bg-[#d4e616]/5 px-5 py-2.5 rounded-full backdrop-blur-md">
              <span className="w-2 h-2 rounded-full bg-[#d4e616] animate-pulse shadow-[0_0_10px_#d4e616]" />
              <span className="text-xs text-[#d4e616] font-mono tracking-[0.2em] uppercase">ابدأ رحلتك الآن</span>
            </div>

            {/* Heading */}
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/40 mb-6 leading-[1.2] tracking-tight dark:drop-shadow-[0_0_60px_rgba(255,255,255,0.1)] text-balance">
              حلم الأمومة، واقعٌ ننسجه معاً
            </h2>

            <p className="text-base md:text-lg text-zinc-400 font-light mb-12 max-w-xl mx-auto text-balance leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              >
                ...
                <div className="relative z-10 w-10 h-10 rounded-full bg-black/20 flex items-center justify-center">
              ...
              <a
                ...
                className="group relative overflow-hidden rounded-2xl  bg-white/[0.03] px-10 py-5 flex items-center gap-4 transition-all duration-500  hover:bg-white/[0.06] w-full sm:w-auto justify-center backdrop-blur-md"
              >
                <span className="text-lg font-bold text-white">اتصل الآن</span>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 text-sm text-zinc-500">
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
                <span>السبت — الخميس: 8:00 ص - 5:00 م</span>
              </div>
