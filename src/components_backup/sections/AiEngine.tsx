...
export function AiEngine() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[120vh] bg-[#020617] overflow-hidden flex items-center justify-center py-32" dir="rtl">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-24 max-w-4xl mx-auto">
          ...
          <motion.h2 
            ...
            className="font-heading text-6xl md:text-8xl font-black text-white tracking-tighter mb-8"
          >
          ...
          <motion.p
            ...
            className="font-sans text-xl md:text-2xl text-zinc-400 font-light leading-relaxed"
          >
        ...
        <div className="relative w-full max-w-3xl aspect-square flex items-center justify-center">
          ...
          >
            ...
            {isInView && (
              <>
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: -100 }} transition={{ delay: 0.5, duration: 0.5 }} className="absolute top-[20%] left-0 font-mono text-xs text-blue-400 bg-[#020617]/80 px-2 py-1  whitespace-nowrap">
                  CELL_DIV_RATE: OPTIMAL
                </motion.div>
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 100 }} transition={{ delay: 0.7, duration: 0.5 }} className="absolute bottom-[30%] right-0 font-mono text-xs text-blue-400 bg-[#020617]/80 px-2 py-1  whitespace-nowrap">
                  GEN_INTEGRITY: 99.9%
                </motion.div>
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: -60 }} transition={{ delay: 0.9, duration: 0.5 }} className="absolute top-0 left-1/2 -translate-x-1/2 font-mono text-xs text-blue-400 bg-[#020617]/80 px-2 py-1  whitespace-nowrap">
