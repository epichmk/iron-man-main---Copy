...
function PartnerCard({ partner }: { partner: typeof partners[0] }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-[1px] rounded-[2rem] bg-white/5 opacity-50 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden pointer-events-none">
        <motion.div
      ...
      {/* Card Content Layer */}
      <div className="absolute inset-0 rounded-[2rem] bg-[#000814]/80 backdrop-blur-xl  group- transition-colors duration-500 overflow-hidden flex items-center justify-center pointer-events-none">
        ...
        >
          <Image
            ...
            alt={partner.name}
            fill
            className="object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.05)] group-hover:drop-shadow-[0_0_20px_rgba(0,102,255,0.3)] transition-all duration-700"
            unoptimized
          />
        </motion.div>
      </div>
...
export function PartnersSection() {
  return (
    <section className="relative py-32 bg-[#00040A] overflow-hidden" style={{ perspective: "2000px" }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-20" dir="rtl">
          ...
          >
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5  mb-8 backdrop-blur-md shadow-[0_0_30px_rgba(0,102,255,0.1)]">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight dark:drop-shadow-2xl">
              شركاء <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-[#0066FF]">النجاح</span>
            </h2>
            
            <p className="font-sans text-lg md:text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed dark:drop-shadow-md">
