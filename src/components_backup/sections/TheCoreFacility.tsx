...
function SecurityBadge({ text, code }: { text: string; code: string }) {
  return (
    <div className="inline-flex items-center  bg-[#001529]/60 backdrop-blur-md rounded-lg overflow-hidden shadow-[0_0_15px_rgba(0,0,0,0.5)]">
...
export function TheCoreFacility() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative min-h-screen py-32 bg-[#000a14] overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-16 min-h-[70vh]">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start" dir="rtl">
          ...
          <motion.h2 
            ...
            className="font-heading text-5xl md:text-7xl font-black text-white tracking-tighter mb-6"
          >
          ...
          <motion.p
            ...
            className="font-sans text-lg md:text-xl text-zinc-400 leading-relaxed font-light mb-10 max-w-lg"
          >
