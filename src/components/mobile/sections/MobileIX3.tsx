...
export function MobileIX3() {
  return (
    <section className="relative w-full h-screen snap-start overflow-hidden bg-[var(--page-bg)]" dir="rtl">
      ...
      {/* IX3 Image Center */}
      <div className="absolute inset-0 z-10 pointer-events-none flex items-start pt-16 justify-center scale-125 drop-shadow-[0_20px_50px_var(--shadow-color)]">
        <div className="relative w-full h-[50vh] flex items-center justify-center p-0 min-h-[50vh]">
          ...
          >
            <Image 
              ...
              fill 
              sizes="100vw"
              className="object-contain object-top opacity-100 drop-shadow-[0_0_30px_var(--border-subtle)]"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[var(--page-bg)]/90 via-transparent to-[var(--page-bg)]/90" />
            <div className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[var(--page-bg)] to-transparent" />
          </div>
        </div>
      </div>

      {/* Cinematic Bottom Gradient Fade for Text */}
      <div className="absolute inset-x-0 bottom-0 h-[60%] bg-gradient-to-t from-[var(--page-bg)] via-[var(--page-bg)]/80 to-transparent pointer-events-none z-20" />
      ...
      <div className="relative z-30 flex flex-col justify-end items-center text-center w-full px-6 pointer-events-auto mt-auto h-full pb-12">
        <div className="w-full drop-shadow-[0_0_30px_var(--shadow-color)] flex flex-col items-center">
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <h2 className="font-heading text-5xl sm:text-6xl leading-[1.05] font-black tracking-tight text-[var(--text-primary)] mb-0 text-center">
              دقة.<br/>
          ...
          <div className="max-w-sm relative mt-2 mx-auto">
            <p className="font-sans text-[var(--text-secondary)] text-[15px] leading-snug font-light dark:drop-shadow-[0_0_15px_rgba(0,0,0,1)] px-2 text-center">
              يُعد نظام <strong className="text-[var(--text-primary)] font-semibold tracking-wide">Olympus IX73 ICSI & IMSI</strong> قمة تكنولوجيا الإنجاب.
            </p>
          </div>
