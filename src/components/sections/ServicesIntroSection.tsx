...
export function ServicesIntroSection() {
  ...
  return (
    <section 
      data-cinematic
      className="relative w-full h-screen bg-[var(--page-bg)] overflow-hidden flex flex-col items-center justify-center snap-center"
      dir="rtl"
    >
      {/* Dynamic Background */}
      <motion.div 
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(to right, var(--shadow-inset) 1px, transparent 1px),
            linear-gradient(to bottom, var(--shadow-inset) 1px, transparent 1px)
          `,
      ...
      <div className="relative w-full flex flex-col items-center justify-center px-6 z-20">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <motion.div 
            ...
            className="mb-6 md:mb-10 inline-flex items-center gap-3 px-5 py-2 rounded-full border border-[var(--border-subtle)] bg-[var(--surface-elevated)] backdrop-blur-md"
          >
            <div className="w-2 h-2 rounded-full bg-accent animate-pulse shadow-[0_0_10px_#d4e616]" />
            <span className="font-sans text-xs md:text-sm font-bold tracking-widest text-[var(--text-secondary)] uppercase pt-1">
          ...
          {/* Epic Typography */}
          <motion.h2 
            initial={noAnim ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, delay: noAnim ? 0 : 0.2 }}
            className="font-heading text-[clamp(2.5rem,6vw,5rem)] leading-[1.1] font-black text-transparent bg-clip-text bg-gradient-to-b from-[var(--text-primary)] via-[var(--text-primary)] to-[var(--text-tertiary)] tracking-tight drop-shadow-[0_20px_40px_rgba(0,0,0,1)] mb-8"
          >
          ...
          <motion.p 
            ...
            className="font-sans text-lg md:text-2xl text-[var(--text-tertiary)] font-light leading-relaxed max-w-3xl text-balance"
          >
