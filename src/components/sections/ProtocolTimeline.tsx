    ...
    <div ref={ref} className={`relative flex items-center justify-between w-full mb-20 md:mb-40 ${isEven ? '' : 'flex-row-reverse'} [perspective:2000px]`}>
      ...
      <div className="absolute right-[20px] md:right-1/2 translate-x-1/2 flex items-center justify-center z-20">
        <motion.div 
          ...
          className={`relative w-8 h-8 md:w-14 md:h-14 rounded-full border bg-[var(--page-bg)] flex items-center justify-center transition-all duration-1000
            ${isInView ? 'border-[#d4e616] shadow-[0_0_50px_rgba(212,230,22,0.4)] scale-110' : 'border-[#d4e616]/20'}`}
        >
          {/* Inner pulsating diamond */}
          <div className={`w-2 h-2 md:w-4 md:h-4 bg-accent rotate-45 transition-all duration-1000 ${isInView ? 'shadow-[0_0_20px_#d4e616] scale-125' : 'opacity-30'}`} />
      ...
      <div className={`w-full md:w-[45%] flex flex-col relative z-30 pr-16 md:pr-0`}>
        <motion.div 
          ...
          className="group relative overflow-visible rounded-3xl p-8 md:p-14 bg-gradient-to-br from-[var(--page-bg)]/80 to-[var(--page-bg)]/90 backdrop-blur-3xl  transition-colors duration-700 #d4e616]/40 hover:bg-[var(--page-bg)]/90 shadow-2xl"
          dir="rtl"
        >
          ...
          <div 
            ...
            style={{ WebkitTextStroke: "2px var(--shadow-inset)", color: "transparent" }}
          >
            {data.id}
          </div>
          ...
          >
            ...
            <div className="w-16 h-[3px] bg-accent mb-10 transition-all duration-700 ease-out group-hover:w-48 group-hover:shadow-[0_0_20px_rgba(212,230,22,0.8)]" />

            <h3 className="font-sans text-3xl md:text-5xl font-bold text-[var(--text-primary)] mb-5 tracking-tight dark:drop-shadow-2xl">
              {data.title}
            </h3>
            <p className="font-mono text-sm md:text-base text-accent mb-8 uppercase tracking-[0.3em] font-bold dark:drop-shadow-md">
              {data.subtitle}
            </p>
            <p className="font-sans text-lg md:text-xl text-[var(--text-secondary)] leading-[1.9] font-light max-w-lg">
              {data.desc}
            </p>
          </div>
        </motion.div>
...
export function ProtocolTimeline() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 md:py-48 bg-[var(--page-bg)] overflow-hidden">
      
      {/* Ambient Masterpiece Lighting */}
      <div className="absolute top-1/4 left-0 w-[50rem] h-[50rem] bg-accent/5 rounded-full blur-[150px] pointer-events-none mix-blend-screen" />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col items-center mb-32 md:mb-48 text-center" dir="rtl">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full #d4e616]/40 bg-accent/10 mb-8 backdrop-blur-md shadow-[0_0_40px_rgba(212,230,22,0.15)]"
          >
            <span className="w-2.5 h-2.5 rounded-full bg-accent animate-pulse" />
            <span className="font-mono text-xs md:text-sm text-accent tracking-[0.4em] uppercase font-bold">
              TREATMENT PATHWAY
            </span>
          </motion.div>
          ...
          <motion.h2 
            ...
            className="font-heading text-[clamp(4rem,12vw,9rem)] font-black text-[var(--text-primary)] tracking-tighter leading-none drop-shadow-2xl"
          >
        ...
        <div className="relative max-w-6xl mx-auto" dir="rtl">
          ...
          <div className="absolute right-[20px] md:right-1/2 top-0 bottom-0 w-[1px] bg-[var(--surface-elevated)] translate-x-1/2" />
