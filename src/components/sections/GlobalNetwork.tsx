...
export function GlobalNetwork() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen bg-[var(--page-bg)] overflow-hidden py-32" dir="rtl">
      
      {/* Background Dots */}
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--border-subtle)_1px,transparent_1px)] bg-[size:20px_20px]" />
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start z-20">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3 py-1 rounded #d4e616]/30 bg-accent/10 mb-6"
          >
          ...
          <motion.h2 
            ...
            className="font-heading text-5xl md:text-7xl font-black text-[var(--text-primary)] tracking-tighter mb-8 leading-[1.1]"
          >
          ...
          <motion.p
            ...
            className="font-sans text-xl text-[var(--text-tertiary)] font-light leading-relaxed mb-10 max-w-lg"
          >
          ...
          >
            {[
              ...
              <div key={i} className="flex items-center gap-4">
                <div className="w-6 h-6 rounded-sm #d4e616]/50 bg-accent/10 flex items-center justify-center">
                   <div className="w-1.5 h-1.5 bg-accent" />
                </div>
                <span className="text-[var(--text-primary)] font-sans">{feature}</span>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="w-full lg:w-1/2 relative h-[500px] md:h-[600px] flex items-center justify-center">
          ...
          <motion.div 
            style={{ y: y1 }}
            className="relative w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full  bg-[radial-gradient(ellipse_at_center,rgba(0,10,20,0.8)_0%,var(--shadow-color)_100%)] shadow-[0_0_80px_rgba(212,230,22,0.1)] flex items-center justify-center overflow-hidden"
          >
            ...
            <div className="absolute top-1/2 left-1/2 w-4 h-4 -translate-x-1/2 -translate-y-1/2 z-30">
               ...
               <div className="relative w-full h-full bg-accent rounded-full shadow-[0_0_20px_rgba(212,230,22,1)]" />
               
               {/* Label */}
               <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 font-mono text-[10px] text-accent whitespace-nowrap bg-[var(--overlay-bg)] px-2 py-1 rounded #d4e616]/30 backdrop-blur-sm">
                 DESTINATION_LOCKED
               </div>
            </div>
          ...
          <motion.div style={{ y: y2 }} className="absolute -right-4 md:-right-12 top-1/4 bg-[var(--surface-elevated)]/80 backdrop-blur-md  p-4 rounded-xl shadow-2xl z-30">
            <span className="font-mono text-xs text-[var(--text-muted-light)] mb-1 block">INBOUND_FLIGHT</span>
            <div className="flex items-center gap-3">
              <span className="text-[var(--text-primary)] font-bold font-mono">LHR</span>
              <div className="w-8 h-[1px] bg-[var(--surface-hover)] relative">
              ...
              <span className="text-accent font-bold font-mono">SAH</span>
            </div>
          </motion.div>
