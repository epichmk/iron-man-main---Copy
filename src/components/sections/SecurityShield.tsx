...
export function SecurityShield() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[120vh] bg-[var(--page-bg)] overflow-hidden flex items-center justify-center py-32" dir="rtl">
      
      {/* The Animated Mechanical Blast Doors */}
      <motion.div 
        style={{ x: leftDoorX }}
        className="absolute top-0 left-0 w-1/2 h-full bg-[var(--page-bg)] border-r-4 border-blue-900/50 z-0 flex items-center justify-end overflow-hidden"
      >
        <div className="w-full h-[20%] border-y border-[var(--border-subtle)] opacity-20 absolute top-[20%]" />
        <div className="w-full h-[20%] border-y border-[var(--border-subtle)] opacity-20 absolute bottom-[20%]" />
        {/* Warning stripes */}
      ...
      <motion.div 
        style={{ x: rightDoorX }}
        className="absolute top-0 right-0 w-1/2 h-full bg-[var(--page-bg)] border-l-4 border-blue-900/50 z-0 flex items-center justify-start overflow-hidden"
      >
        <div className="w-full h-[20%] border-y border-[var(--border-subtle)] opacity-20 absolute top-[20%]" />
        <div className="w-full h-[20%] border-y border-[var(--border-subtle)] opacity-20 absolute bottom-[20%]" />
        {/* Warning stripes */}
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-20 flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="bg-[var(--overlay-bg)] backdrop-blur-xl  p-10 md:p-16 rounded-3xl text-center max-w-4xl w-full shadow-[0_0_50px_var(--shadow-color)] relative overflow-hidden"
        >
          {/* Corner accents */}
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-[var(--text-primary)] mb-6 tracking-tight">
            ����� ����� �������� ��������
          </h2>
          
          <p className="text-[var(--text-secondary)] font-light text-lg md:text-xl leading-relaxed mb-10 max-w-2xl mx-auto">
            �� ���� ����� ������. ���� ���� ���� �������� ����� (RFID) ���� ������ ������ ����� ������� ����� ������� �������� ����� 100%. ������ ������ ����� ����� ���� ������� ��� ���� ��������.
          </p>

          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <div className="flex items-center gap-3 bg-[var(--overlay-bg)]  px-6 py-3 rounded-full">
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
              <span className="text-[var(--text-primary)] font-mono text-sm tracking-widest">RFID_TRACKING: SECURE</span>
            </div>
            <div className="flex items-center gap-3 bg-[var(--overlay-bg)]  px-6 py-3 rounded-full">
              <div className="w-2 h-2 rounded-full bg-blue-400 animate-pulse" />
              <span className="text-[var(--text-primary)] font-mono text-sm tracking-widest">ENCRYPTION: 256-BIT</span>
            </div>
          </div>
