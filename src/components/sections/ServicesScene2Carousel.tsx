...
export function ServicesScene2Carousel() {
  ...
  return (
    <section ref={containerRef} className="relative bg-[var(--page-bg)] w-full h-[100dvh] overflow-hidden flex flex-col justify-center">
      <LazyVideo src="/services-section-2.mp4" autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover z-0 opacity-[var(--theme-bg-img-opacity)]" />
      <div 
        ref={carouselRef}
