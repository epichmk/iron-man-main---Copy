  ...
  return (
    ...
    >
      <div className="absolute inset-0 w-full h-[100dvh] overflow-hidden pointer-events-none z-0">
        <LazyVideo src="/cinematic-blog-scrub.mp4" autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover opacity-[var(--theme-bg-img-opacity)]" />
